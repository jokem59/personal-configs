...
silent only
cd C:\Projects\AdventOfCode\2018\day2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +68 day2-1.cpp
badd +1 \Projects\AdventOfCode\2018\day1\day1-2.cpp
badd +9 \Users\joeki\.gitconfig
badd +1 input.txt
badd +18 \tools\personal-configs\SetupWinDevEnv.ps1
badd +0 day2-2.cpp
badd +0 ..\day1\readme.md
badd +0 ..\day1\day1-2v2.cpp
badd +0 ..\day1\input.txt
argglobal
silent! argdel *
$argadd day2-1.cpp
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 50 - ((49 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
normal! 022|
tabedit ..\day1\input.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 557 - ((73 * winheight(0) + 37) / 74)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
557
normal! 0
tabedit ..\day1\readme.md
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
