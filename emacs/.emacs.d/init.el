...
")
 ...
 '(package-selected-packages
   '(all-the-icons-completion auto-complete orderless marginalia consult-ls-git consult vertico mu4e-column-faces use-package eglot 0blayout mini-frame cmake-mode gnuplot gnuplot-mode org-tree-slide dired-narrow rainbow-delimiters go-mode org-roam dumb-jump flymd impatient-mode nhexl-mode undo-tree all-the-icons smex company smart-mode-line-atom-one-dark-theme smart-mode-line avy expand-region rust-mode tide web-mode js3-mode yaml-mode markdown-mode csharp-mode log4j-mode git-gutter gruvbox-theme doom-themes))
