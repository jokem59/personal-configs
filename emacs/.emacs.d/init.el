...
;; Don't pop up the *Warnings* buffer for async native-compilation warnings
;; (e.g. expand-region's per-mode files referencing functions from modes that
;; aren't loaded at compile time). Warnings are still logged to
...
(custom-set-variables
 ...
 '(highlight-tail-colors
   ((("#2c3e3c" "#2a3b2e" "green") . 0)
    (("#313d49" "#2f3a3b" "brightcyan") . 20)))
 ...
 '(pulsar-pulse-functions
   '(recenter-top-bottom move-to-window-line-top-bottom reposition-window
                         ...
                         scroll-down-command next-buffer
                         previous-buffer windmove-right windmove-left
                         windmove-up windmove-down
                         windmove-swap-states-right
                         windmove-swap-states-left
                         windmove-swap-states-up
                         windmove-swap-states-down tab-new tab-close
                         tab-next org-next-visible-heading
