...
(custom-set-variables
 ...
 '(initial-scratch-message
   "_This buffer is for text that is not saved, active mode is org-mode_\12_To create a file, visit it with \\[find-file] and enter text in its buffer_\12\12")
 ...
 '(package-selected-packages
   '(all-the-icons-completion auto-complete orderless marginalia consult-ls-git consult vertico mu4e-column-faces use-package eglot 0blayout mini-frame cmake-mode gnuplot gnuplot-mode org-tree-slide dired-narrow rainbow-delimiters go-mode org-roam dumb-jump flymd impatient-mode nhexl-mode undo-tree smex company smart-mode-line-atom-one-dark-theme smart-mode-line avy expand-region rust-mode tide web-mode js3-mode yaml-mode markdown-mode csharp-mode log4j-mode gruvbox-theme doom-themes))
